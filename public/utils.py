...
from draw import draw_skeleton_kps_on_origin
...
def get_vout_H264(video_raw_name):
    video_writer = iio.get_writer(
        "{}".format(video_raw_name), format="ffmpeg", mode="I", fps=30, codec="libx264", pixelformat="yuv420p",
...
def two_list_flat(two_dimensional_list: list):
    """
    二维列表展开
    :param two_dimensional_list: 二维列表
    :return: 一维列表
    """
